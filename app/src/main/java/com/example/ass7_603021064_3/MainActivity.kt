package com.example.ass7_603021064_3
...
import kotlinx.android.synthetic.main.add_dialog_layout.view.radioGroup
...
class MainActivity : AppCompatActivity() {
    ...
    fun testEmployeeData() {
        EmployeeList.add(Employee("Adisorn", "Male","adisorn.606@gmail.com",30000))
        EmployeeList.add(Employee("Wanjaen", "Female","wanjaen_p@gmail.com",25000))
    }
}